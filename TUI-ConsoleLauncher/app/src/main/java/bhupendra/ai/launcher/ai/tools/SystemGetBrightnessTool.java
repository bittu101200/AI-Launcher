...
public class SystemGetBrightnessTool extends BaseAITool {

    private static final String TAG = "SystemGetBrightnessTool";
    private MainPack mainPack;

    public SystemGetBrightnessTool(String name, String description, Map<String, String> parameters, ToolRiskClass riskClass) {
