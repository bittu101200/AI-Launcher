...
public class SystemMemoryRetrieveTool extends BaseAITool {

    private static final String TAG = "SystemMemoryRetrieveTool";
    private MainPack mainPack;

    public SystemMemoryRetrieveTool(String name, String description, Map<String, String> parameters, ToolRiskClass riskClass) {
