...
public class SystemListTasksTool extends BaseAITool {

    private static final String TAG = "SystemListTasksTool";
    private MainPack mainPack;

    public SystemListTasksTool(String name, String description, Map<String, String> parameters, ToolRiskClass riskClass) {
