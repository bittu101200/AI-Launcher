...
public class SystemSearchConfigTool extends BaseAITool {

    private static final String TAG = "SystemSearchConfigTool";
    private MainPack mainPack;

    public SystemSearchConfigTool(String name, String description, Map<String, String> parameters, ToolRiskClass riskClass) {
