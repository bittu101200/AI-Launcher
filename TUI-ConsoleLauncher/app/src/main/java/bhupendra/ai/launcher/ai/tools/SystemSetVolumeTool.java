...
public class SystemSetVolumeTool extends BaseAITool {

    private static final String TAG = "SystemSetVolumeTool";
    private MainPack mainPack;

    public SystemSetVolumeTool(String name, String description, Map<String, String> parameters, ToolRiskClass riskClass) {
