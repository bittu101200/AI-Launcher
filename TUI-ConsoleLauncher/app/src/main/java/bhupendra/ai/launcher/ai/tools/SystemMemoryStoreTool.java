...
public class SystemMemoryStoreTool extends BaseAITool {

    private static final String TAG = "SystemMemoryStoreTool";
    private MainPack mainPack;

    public SystemMemoryStoreTool(String name, String description, Map<String, String> parameters, ToolRiskClass riskClass) {
