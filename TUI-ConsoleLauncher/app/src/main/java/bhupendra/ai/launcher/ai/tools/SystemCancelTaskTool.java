...
public class SystemCancelTaskTool extends BaseAITool {

    private static final String TAG = "SystemCancelTaskTool";
    private MainPack mainPack;

    public SystemCancelTaskTool(String name, String description, Map<String, String> parameters, ToolRiskClass riskClass) {
